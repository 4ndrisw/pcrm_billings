...
<div class="panel-body mtop10">
   ...
   <div class="table-responsive s_table">
      <table class="table billing-items-table items table-main-billing-edit has-calculations no-mtop">
         <thead>
            <tr>
               <th></th>
               <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('billing_table_item_heading'); ?></th>
               <th width="25%" align="left"><?php echo _l('billing_table_item_description'); ?></th>
               <?php
                  ...
                  $qty_heading = _l('billing_table_quantity_heading');
                  if(isset($billing) && $billing->show_quantity_as == 2){
                  $qty_heading = _l('billing_table_hours_heading');
                  } else if(isset($billing) && $billing->show_quantity_as == 3){
                  $qty_heading = _l('billing_table_quantity_heading') . '/' . _l('billing_table_hours_heading');
                  }
                  ?>
               <th width="10%" class="qty" align="right"><?php echo $qty_heading; ?></th>
               <th width="15%" align="right"><?php echo _l('billing_table_rate_heading'); ?></th>
               <th width="20%" align="right"><?php echo _l('billing_table_tax_heading'); ?></th>
               <th width="10%" align="right"><?php echo _l('billing_table_amount_heading'); ?></th>
         ...
         <tbody>
            ...
            <?php if (isset($billing) || isset($add_items)) {
               $i               = 1;
               $items_indicator = 'newitems';
               if (isset($billing)) {
                 $add_items       = $billing->items;
               ...
               foreach ($add_items as $item) {
                 ...
                 if(!isset($is_proposal)){
                  $billing_item_taxes = get_billing_item_taxes($item['id']);
                } else {
                  $billing_item_taxes = get_proposal_item_taxes($item['id']);
                }
                if ($item['id'] == 0) {
                 $billing_item_taxes = $item['taxname'];
                 $manual              = true;
               }
               ...
               $table_row .= '<td class="taxrate">' . $this->misc_model->get_taxes_dropdown_template('' . $items_indicator . '[' . $i . '][taxname][]', $billing_item_taxes, (isset($is_proposal) ? 'proposal' : 'billing'), $item['id'], true, $manual) . '</td>';
         ...
         <tbody>
            ...
            <tr id="discount_area">
               <td>
                  <div class="row">
                     <div class="col-md-7">
                        <span class="bold"><?php echo _l('billing_discount'); ?></span>
                     </div>
                     <div class="col-md-5">
                        <div class="input-group" id="discount-total">

                           <input type="number" value="<?php echo (isset($billing) ? $billing->discount_percent : 0); ?>" class="form-control pull-left input-discount-percent<?php if(isset($billing) && !is_sale_discount($billing,'percent') && is_sale_discount_applied($billing)){echo ' hide';} ?>" min="0" max="100" name="discount_percent">

                           <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php echo (isset($billing) ? $billing->discount_total : 0); ?>" class="form-control pull-left input-discount-fixed<?php if(!isset($billing) || (isset($billing) && !is_sale_discount($billing,'fixed'))){echo ' hide';} ?>" min="0" name="discount_total">
                           ...
                           <div class="input-group-addon">
                              <div class="dropdown">
                                 ...
                                 <span class="discount-total-type-selected">
                                  <?php if(!isset($billing) || isset($billing) && (is_sale_discount($billing,'percent') || !is_sale_discount_applied($billing))) {
                                    echo '%';
                                    } else {
                                 ...
                                 <ul class="dropdown-menu" id="discount-total-type-dropdown" aria-labelledby="dropdown_menu_tax_total_type">
                                   <li>
                                    <a href="#" class="discount-total-type discount-type-percent<?php if(!isset($billing) || (isset($billing) && is_sale_discount($billing,'percent')) || (isset($billing) && !is_sale_discount_applied($billing))){echo ' selected';} ?>">%</a>
                                  </li>
                                  <li>
                                    <a href="#" class="discount-total-type discount-type-fixed<?php if(isset($billing) && is_sale_discount($billing,'fixed')){echo ' selected';} ?>">
            ...
            <tr id="pph-area">
               <td>
                  <div class="row">
                     <div class="col-md-7">
                        <span class="bold"><?php echo _l('billing_pph'); ?></span>
                     </div>
                     <div class="col-md-5">
                        <div class="input-group" id="discount-total">

                        <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if(isset($billing)){echo $billing->pph; } else { echo 0; }?>" class="form-control pull-left" name="pph">
                        <div class="input-group-addon">
            ...
            <tr>
               <td>
                  <div class="row">
                     ...
                     <div class="col-md-5">
                        <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if(isset($billing)){echo $billing->adjustment; } else { echo 0; } ?>" class="form-control pull-left" name="adjustment">
                     </div>
                  </div>
               </td>
