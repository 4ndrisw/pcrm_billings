...
<div id="wrapper">
   <div class="content accounting-template billing">
      <div class="row">
         ...
         if($this->input->get('billing_request_id')) {
             echo form_hidden('billing_request_id', $this->input->get('billing_request_id'));
         }
         ?>
               ...
               <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                bbbbbbbbbbbbbbbbbbbbbbbbb<br />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php include_once(APPPATH . 'views/admin/billings/billing_and_shipping_template.php'); ?>
                                    </div>
                                    <div class="col-md-6">
                  ...
                  <p class="no-mbot pull-left mtop5 btn-toolbar-notice"><?php echo _l('include_billing_items_merge_field_help','<b>{billing_items}</b>'); ?></p>
                    <?php
                      ...
                      if(isset($billing->id)){
                        $cancel = $_SERVER['HTTP_REFERER'].'#'.$billing->id;
                      }
                     ?>
